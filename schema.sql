...
CREATE TABLE IF NOT EXISTS announcements (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  title TEXT NOT NULL DEFAULT '🎱 8 BALL እጣ',
...
ALTER TABLE announcements ADD COLUMN IF NOT EXISTS title TEXT NOT NULL DEFAULT '🎱 8 BALL እጣ';
ALTER TABLE announcements ALTER COLUMN title SET DEFAULT '🎱 8 BALL እጣ';
